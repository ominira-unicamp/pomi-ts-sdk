...
import type { getCalendarEventsInput, getCalendarEventsOutput, getCalendarFeedInput, getCalendarFeedOutput, getCalendarTagsInput, getCalendarTagsOutput, getCatalogCoursesInput, getCatalogCoursesOutput, getCatalogProgramsInput, getCatalogProgramsOutput, getCatalogsInput, getCatalogsOutput, getClassesInput, getClassesOutput, getClassSchedulesInput, getClassSchedulesOutput, getCoauthorsInput, getCoauthorsOutput, getCoordinatorsInput, getCoordinatorsOutput, getCoursesInput, getCoursesOutput, getCurriculumSuggestionsInput, getCurriculumSuggestionsOutput, getDailyMenusInput, getDailyMenusOutput, getDepartmentsInput, getDepartmentsOutput, getExchangeNoticesInput, getExchangeNoticesOutput, getKeywordsInput, getKeywordsOutput, getLanguagesInput, getLanguagesOutput, getProfessorDataPortalProfilesInput, getProfessorDataPortalProfilesOutput, getProfessorPositionsInput, getProfessorPositionsOutput, getProfessorsInput, getProfessorsOutput, getProgramsInput, getProgramsOutput, getRoomsInput, getRoomsOutput, getSpecializationsInput, getSpecializationsOutput, getStudyPeriodsInput, getStudyPeriodsOutput, getUnitsInput, getUnitsOutput, listCalendarEventsInput, listCalendarEventsOutput, listCalendarTagsInput, listCalendarTagsOutput, listCatalogCoursesInput, listCatalogCoursesOutput, listCatalogProgramsInput, listCatalogProgramsOutput, listCatalogsInput, listCatalogsOutput, listClassesInput, listClassesOutput, listClassSchedulesInput, listClassSchedulesOutput, listCoauthorsInput, listCoauthorsOutput, listCoordinatorsInput, listCoordinatorsOutput, listCoursesInput, listCoursesOutput, listCurriculumSuggestionsInput, listCurriculumSuggestionsOutput, listDailyMenusInput, listDailyMenusOutput, listDepartmentsInput, listDepartmentsOutput, listExchangeNoticesInput, listExchangeNoticesOutput, listExchangePlacesInput, listExchangePlacesOutput, listKeywordsInput, listKeywordsOutput, listLanguagesInput, listLanguagesOutput, listProfessorDataPortalProfilesInput, listProfessorDataPortalProfilesOutput, listProfessorPositionsInput, listProfessorPositionsOutput, listProfessorsInput, listProfessorsOutput, listProgramsInput, listProgramsOutput, listRoomsInput, listRoomsOutput, listSpecializationsInput, listSpecializationsOutput, listStudyPeriodsInput, listStudyPeriodsOutput, listUnitsInput, listUnitsOutput } from './operations.js'
